...
typedef enum
{
    ...
    WEDGEPYLD_SMS_COMMAND = 0x31,
    WEDGEPYLD_SMS_COMMAND_RESPONSE = 0x32,
    WEDGEPYLD_SMS_DIAGNOSTIC_RESPONSE = 0x33,
    WEDGEPYLD_SMS_DIAGNOSTIC_REQUEST = 0x34,

    WEDGEPYLD_SMS_INVALID_MAX
} WEDGEPYLDTypeDef;
...
#define WEDGE_DEVICE_INFO_VERIFY (0xDCECDECE)
#define WEDGE_DEVICE_INFO_DEFAULT (0xFFFFFFFF)
#define WEDGE_DEVICE_INFO_CELL_SIZE_BYTES (2048)
#define WEDGE_DEVICE_INFO_OFFSET (WEDGE_POWER_LOST_INDICATE_END_ADDR + 1)
#define WEDGE_DEVICE_INFO_START_ADDR (WEDGE_STORAGE_BASE_ADDR + WEDGE_DEVICE_INFO_OFFSET)
#if TC30M_TEST_CONFIG_OFF
#define WEDGE_DEVICE_INFO_TOTAL_SIZE (WEDGE_STORAGE_SECTOR_SIZE * 240)
#else
#define WEDGE_DEVICE_INFO_TOTAL_SIZE (WEDGE_STORAGE_SECTOR_SIZE * 8) /*Just for test!*/
#endif /* TC30M_TEST_CONFIG_OFF */
#define WEDGE_DEVICE_INFO_TOTAL_NUM (WEDGE_DEVICE_INFO_TOTAL_SIZE / WEDGE_DEVICE_INFO_CELL_SIZE_BYTES)
#define WEDGE_DEVICE_INFO_END_ADDR (WEDGE_DEVICE_INFO_START_ADDR + WEDGE_DEVICE_INFO_TOTAL_SIZE - 1)

#define WEDGE_MSG_QUE_OFFSET (WEDGE_DEVICE_INFO_END_ADDR + 1)
#define WEDGE_MSG_QUE_START_ADDR (WEDGE_STORAGE_BASE_ADDR + WEDGE_MSG_QUE_OFFSET)
#if TC30M_TEST_CONFIG_OFF
#define WEDGE_MSG_QUE_TOTAL_SIZE (WEDGE_STORAGE_SECTOR_SIZE * 192)
#else
