...
typedef enum {
  PSENSOR_CMP_LOW				=		0x00,
  PSENSOR_CMP_HIGH				=		0x01,
  PSENSOR_STAT_LOW				=		0x02,
  PSENSOR_STAT_HIGH				=		0x03,
  PSENSOR_STAT_UNKOWN			=		0xff
} Pstate_t;
...
// GSENSOR INT1
#define GSENSOR_INT1_PORT  		PB4_G_INT1_GPIO_Port
#define GSENSOR_INT1_PIN  	 	PB4_G_INT1_Pin
extern I2C_HandleTypeDef hi2c1;
#define GSENSOR_I2C_DEF (&hi2c1)
#define BIT(x) ( (x) )
